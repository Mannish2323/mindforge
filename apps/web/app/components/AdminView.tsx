    ...
    switch (activeTab) {
      ...
      case 'billing':
        return (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)' }}>
            {[
              { id: 'free',    name: 'Free',           color: '#64748B', hearts: 5,   ai: 5,  lessons: 5  },
              { id: 'starter', name: 'Starter — ₹99',  color: '#0EA5E9', hearts: 25,  ai: 15, lessons: 15 },
              { id: 'plus',    name: 'Plus — ₹149',    color: '#8B5CF6', hearts: 50,  ai: 30, lessons: 30 },
