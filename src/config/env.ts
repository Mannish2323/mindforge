/**
 * MindForge — Centralized Environment Config
 */

export const env = {
  NODE_ENV: process.env.NODE_ENV || 'development',
  SUPABASE_URL: process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://dummy.supabase.co',
  SUPABASE_ANON_KEY: process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'dummy-anon-key',
  ...
  APP_URL: process.env.NEXT_PUBLIC_APP_URL || 'https://mindforge.yamplelabs.com',
};
