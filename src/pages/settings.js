...
export function renderSettings(container) {
    ...
    <div class="page-settings page-enter">
      ...
      <div class="settings-section">
        ...
        <div class="setting-row" id="theme-row">
          <div class="setting-icon" style="display: inline-flex; align-items: center; justify-content: center;">
            <svg viewBox="0 0 24 24" style="width:1.2em; height:1.2em; fill:none; stroke:currentColor; stroke-width:2;" xmlns="http://www.w3.org/2000/svg"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
          </div>
      ...
      <div class="settings-section">
        ...
        <div class="setting-row" id="lang-row">
          <div class="setting-icon" style="display: inline-flex; align-items: center; justify-content: center;">
            <svg viewBox="0 0 24 24" style="width:1.2em; height:1.2em; fill:none; stroke:currentColor; stroke-width:2;" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
          </div>
          <div class="setting-text">
      ...
      <div class="settings-section">
        ...
        <div class="setting-row" id="refill-row">
          ...
          <div class="badge badge-red" style="display: inline-flex; align-items: center; gap: 2px;">50 ${Icons.gems()}</div>
        </div>
      ...
      <div style="text-align: center; padding: var(--space-6) 0; color: var(--text-muted); font-size: var(--text-xs); display: flex; flex-direction: column; align-items: center; gap: 4px; justify-content: center;">
        <div style="display: flex; align-items: center; gap: 4px;">Made with <span style="display: inline-flex; color: var(--red); font-size: 14px;">${Icons.hearts()}</span> for Japanese learners</div>
        <span>日本語を一緒に学ぼう！</span>
      </div>
    </div>
  `;
  ...
  document.getElementById('refill-row').addEventListener('click', () => {
    ...
    if (s.hearts >= s.maxHearts) {
      showToast('Hearts are already full!', 'info');
