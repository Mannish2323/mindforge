    ...
    <div className="animate-fadein" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)' }}>
      ...
      >
        <div className="continue-info">
          ...
          <h3 style={{ fontWeight: 900, marginTop: '4px', fontSize: 'var(--text-lg)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {isNewUser ? 'Begin Learning Japanese' : 'Continue Learning'}
          </h3>
          <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-2)', marginTop: '6px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
